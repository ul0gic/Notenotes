...
- Whether Pocket should be the next Canvas2D view, or whether the next slice
  should pause new views and optimize shared render paths.
...
- Exponential envelope curves for synth amplitude/filter movement.
