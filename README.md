...
| **Controller** | Gamepad-as-instrument via the Web Gamepad API. The **Labs** button opens the learnable mapper, while the Controller screen shows connection state, trigger assignments, live highlights, current bindings, and saved binding presets. Pads bindings remember whether they were learned as notes, chords, or Root pads. |
