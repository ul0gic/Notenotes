...
- **Mobile and desktop focus, including iOS Safari** - touch drag-and-drop everywhere, a cleaner labeled transport menu on narrow screens, a tap-friendly BPM editor, a collapsible snippets tray, denser Pads spacing so more notes fit without clipping, a wider mobile Patch picker lane, hidden keyboard-hint badges on phone layouts, and extra audio unlock nudges when a real note or drum hit happens.
